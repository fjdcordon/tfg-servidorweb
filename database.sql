...
--
-- Host: localhost    Database: servWeb
-- ------------------------------------------------------
...
--
-- Current Database: `servWeb`
--
CREATE USER 'servWeb'@'localhost' IDENTIFIED BY 'servWeb';
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `servWeb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
GRANT ALL PRIVILEGES ON *.* TO 'servWeb'@'localhost';
USE `servWeb`;
...
-- Dump completed on 2022-05-10 13:31:18
